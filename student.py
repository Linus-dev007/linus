...
class studentClass:
    def __init__(self,root):
        ...
        #========== title ============
        title=Label(self.root, text="Manage Student Detailse",font=("times new roman","20","bold","italic"),bg="#033054",fg='white').place(x=10,y=15,width=1180,height=35)
        #======== Variables ==========
        ...
        text_state=Entry(self.root,textvariable=self.var_state,font=("goudy old style",15),bg='lightyellow').place(x=150,y=220,width=140)

        lbl_city=Label(self.root,text="City",font=("goudy old style",15,"bold"),bg='white').place(x=300,y=220)
        text_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15),bg='lightyellow').place(x=350,y=220,width=120)

        lbl_pin=Label(self.root,text="Pin",font=("goudy old style",15,"bold"),bg='white').place(x=490,y=220)
        text_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15),bg='lightyellow').place(x=550,y=220,width=130)
        ...
        self.fetch_course()
        text_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=480,y=60,width=200)
        ...
        self.txt_adress.place(x=150,y=260,width=530,height=120)

        #============== Buttons ===============
        self.btn_add=Button(self.root,text="Save",font=("times new roman",16,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.add)
        self.btn_add.place(x=150,y=400,width=110,height=40)
        self.btn_update=Button(self.root,text="Update",font=("times new roman",16,"bold"),bg="#4caf50",fg="white",cursor="hand2",command=self.update)
        self.btn_update.place(x=270,y=400,width=110,height=40)
        self.btn_delete=Button(self.root,text="Delete",font=("times new roman",16,"bold"),bg="#f44336",fg="white",cursor="hand2",command=self.delete)
        self.btn_delete.place(x=390,y=400,width=110,height=40)
        self.btn_clear=Button(self.root,text="Clear",font=("times new roman",16,"bold"),bg="#607d8b",fg="white",cursor="hand2",command=self.clear)
        self.btn_clear.place(x=510,y=400,width=110,height=40)
        
        #=========== Search Panel ============
        self.var_search=StringVar()
        lbl_search_roll=Label(self.root,text="Roll No. :",font=("times new roman",15,"bold"),bg="white").place(x=720,y=62)
        lbl_search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15),bg='lightyellow').place(x=840,y=63,width=200)
        btn_search=Button(self.root,text="Search",font=("times new roman",14,"italic"),bg="#2196f3",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
        ...
        self.CourseTable=ttk.Treeview(self.C_Fram,columns=("roll","name","email","gender","dob","contact","admission","course","state","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
        ...
        self.CourseTable.column("dob",width=250)
        self.CourseTable.column("contact",width=250)
        self.CourseTable.column("admission",width=250)
        self.CourseTable.column("course",width=250)
        self.CourseTable.column("state",width=250)
        self.CourseTable.column("city",width=250)
        self.CourseTable.column("pin",width=250)
        self.CourseTable.column("address",width=250)
